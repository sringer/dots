...
if not awful.util.file_readable(shared .. "/icons/awesome32.png") then
...
wallpaper0    = themedir .. "/background.png"
wallpaperDefault    = sharedthemes .. "/default/background.png"
...
theme.awesome_icon = themedir .. "/awesome32.png"
